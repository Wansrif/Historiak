...
<main>
  <div class="container">
    <div class="row">
      <div class="col">
        <h2 class="fw-bold">Form Tambah Data Tokoh Kerajaan</h2>
        <hr>

        <div class="col-12">
          <form action="<?= base_url('tokohadmin/save'); ?>" method="POST" autocomplete="off"
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <img src="<?= base_url('img/tokoh/defaultTokoh.jpeg'); ?>" class="img-thumbnail img-preview">
              </div>
              <div class="col-sm-8">
