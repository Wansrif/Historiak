  ...
  <div class="container">
    <div class="row">
      <div class="col">
        ...
        <hr>
        <a href="<?= base_url('tokohadmin'); ?>/<?= $tokoh['slug']; ?>" class="text-reset"><i
            class='bx bx-arrow-to-left mb-3'></i>
          Kembali ke detail</a>
        <div class="col-12">
          <form action="<?= base_url('tokohadmin/update'); ?>/<?= $tokoh['id_tokoh']; ?>" method="POST"
            autocomplete="off" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <input type="hidden" name="slug" value="<?= $tokoh['slug']; ?>">
            <input type="hidden" name="gambarLama" value="<?= $tokoh['gambar']; ?>">
            <div class="form-group row">
              <label for="judul" class="col-sm-2 col-form-label">Judul</label>
              <div class="col-sm-10">
                <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>"
                  id="judul" name="judul" autofocus value="<?= (old('judul')) ? old('judul') : $tokoh['judul'] ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control <?= ($validation->hasError('sumber')) ? 'is-invalid' : ''; ?>"
                  id="sumber" name="sumber" value="<?= (old('sumber')) ? old('sumber') : $tokoh['sumber'] ?>">
                <div class="invalid-feedback">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <img src="<?= base_url('img/tokoh'); ?>/<?= $tokoh['gambar']; ?>" class="img-thumbnail img-preview">
              </div>
              <div class="col-sm-8">
                <div class="custom-file">
                  ...
                  <label class="custom-file-label" for="gambar"><?= $tokoh['gambar']; ?></label>
                </div>
              </div>
            </div>
            <?php 
            $videoURL = str_replace("watch?v=", "embed/", $tokoh['video']);
            ?>
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="url" class="form-control <?= ($validation->hasError('video')) ? 'is-invalid' : ''; ?>"
                  id="video" name="video" value="<?= (old('video')) ? old('video') : $tokoh['video'] ?>">
                <div class="invalid-feedback">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-12">
                <textarea class="form-control <?= ($validation->hasError('isi')) ? 'is-invalid' : ''; ?>" id="isi"
                  name="isi" required><?= $tokoh['isi'] ?></textarea>
                <div class="invalid-feedback">
