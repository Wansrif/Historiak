...
<main>
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="fw-bold">Form Tambah Data Galeri</h2>
        <hr>
        <a href="<?= base_url('galeriadmin'); ?>" class="text-reset"><i class='bx bx-arrow-to-left mb-3'></i> Kembali ke
          daftar galeri</a>
        <div class="col-12">
          <form action="<?= base_url('galeriadmin/save'); ?>" method="POST" autocomplete="off"
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <img src="<?= base_url('img/galeri/defaultGaleri.jpg'); ?>" class="img-thumbnail img-preview">
              </div>
              <div class="col-sm-8">
