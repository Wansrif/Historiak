...
<main>
  <div class="container">
    <div class="row">
      <div class="col">
        <h2 class="fw-bold">Form Ubah Data Kerajaan</h2>
        <hr>
        <a href="<?= base_url('kerajaanadmin'); ?>/<?= $kerajaan['slug']; ?>" class="text-reset"><i
            class='bx bx-arrow-to-left mb-3'></i>
          Kembali ke detail</a>
        <div class="col-12">
          <form action="<?= base_url('kerajaanadmin/update'); ?>/<?= $kerajaan['id_kerajaan']; ?>" method="POST"
            autocomplete="off" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <input type="hidden" name="slug" value="<?= $kerajaan['slug']; ?>">
            <input type="hidden" name="gambarLama" value="<?= $kerajaan['gambar']; ?>">
            <div class="form-group row">
              <label for="judul" class="col-sm-2 col-form-label">Judul</label>
              <div class="col-sm-10">
                <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>"
                  id="judul" name="judul" autofocus value="<?= (old('judul')) ? old('judul') : $kerajaan['judul'] ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control <?= ($validation->hasError('sumber')) ? 'is-invalid' : ''; ?>"
                  id="sumber" name="sumber" value="<?= (old('sumber')) ? old('sumber') : $kerajaan['sumber'] ?>">
                <div class="invalid-feedback">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <div class="custom-file">
                  ...
                  <label class="custom-file-label" for="gambar"><?= $kerajaan['gambar']; ?></label>
                </div>
              </div>
            </div>
            <?php 
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="url" class="form-control <?= ($validation->hasError('video')) ? 'is-invalid' : ''; ?>"
                  id="video" name="video" value="<?= (old('video')) ? old('video') : $kerajaan['video'] ?>">
                <div class="invalid-feedback">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-12">
                <textarea
                  class="ck-editor__editable_inline form-control <?= ($validation->hasError('isi')) ? 'is-invalid' : ''; ?>"
                  id="isi" name="isi"><?= (old('isi')) ? old('isi') : $kerajaan['isi'] ?></textarea>
                <div class="invalid-feedback">
