    ...
    <div class="row">
      <div class="col-md">
        ...
        <div class="row justify-content-between">
          <div class="col-md-4">
            <a href="<?= base_url('kuisadmin/create'); ?>" class="btn text-white tambah mb-3"><i
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tbody>
              ...
              <?php $pertanyaan = str_replace(['<p>', '</p>'], '', $k['pertanyaan']); ?>
              <tr>
                <th class="nomor" scope="row"><?= $i++; ?></th>
                <td><?= word_limiter($pertanyaan, 9, '...' ); ?></td>
                <td><?= Date("d-m-Y / H:i", strtotime($k['created_at'])); ?> WIB</td>
                <td>
                  <a href="<?= base_url('kuisadmin'); ?>/<?= $k['slug']; ?>" class="btn detail">Detail</a>
                </td>
              </tr>
              <?php endforeach; ?>
            </tbody>
        ...
        <?= $pager->links('kuis', 'custom_pagination'); ?>
      </div>
    </div>
  </div>
</main>
