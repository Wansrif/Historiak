  ...
  <div class="container">
    <div class="row">
      <div class="col">
        ...
        <div class="row">
          <div class="col">
            <form action="<?= base_url('kuisadmin/save'); ?>" method="post" autocomplete="off">
              <?= csrf_field(); ?>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control <?= ($validation->hasError('pertanyaan')) ? 'is-invalid' : ''; ?>"
                    id="isi" name="pertanyaan"><?= old('pertanyaan'); ?></textarea>
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text"
                    ...
                    name="pilihan1" value="<?= old('pilihan1'); ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text"
                    ...
                    name="pilihan2" value="<?= old('pilihan2'); ?>">
                  <div class="invalid-feedback">
              ...
              <div class=" mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text"
                    ...
                    name="pilihan3" value="<?= old('pilihan3'); ?>">
                  <div class="invalid-feedback">
